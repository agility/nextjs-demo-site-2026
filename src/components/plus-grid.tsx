  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 hidden border-b border-black/5 dark:border-white/10 group-last/row:block"></div>
        <div className="absolute inset-x-0 bottom-2 hidden border-b border-black/5 dark:border-white/10 group-last/row:block"></div>
      </div>
      {children}
    </div>
  )
